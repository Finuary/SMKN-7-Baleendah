...
<body id="page-top">
  ...
  <div id="wrapper">
      ...
      <li class="nav-item active">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
          ...
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="">Selayang Pandang</a>
    ...
    <div class="container-fluid">
    	<!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Ubah Selayang Pandang</h1>
              ...
              <?php
                if(isset($_GET['pesan'])) {
                  if($_GET['pesan']=="berhasil") {
                    echo "<script>
                              swal('Berhasil', 'Selayang Pandang berhasil diubah!', 'success');
                          </script>
                    ";
                  }else{
                    echo "<script>
                              swal({
                                title: 'Oops!',
                                text: 'Selayang Pandang gagal diubah!',
                                type: 'warning',
                                });
                          </script>
                    ";
      ...
      <form method="post" action="proses_ubah.php?id=<?php echo $data['id']; ?>" enctype="multipart/form-data">
            <label for="judul">Judul</label>
              ...
              <div class="input-group">
                  <input type="text" name="pembuka" value="<?php echo $data['pembuka']; ?>" class="form-control" id="pembuka">
              </div>
        ...
        <div>
          <a href="selayang_pandang.php"><button type="button" class="btn btn-danger">Batal</button></a>
