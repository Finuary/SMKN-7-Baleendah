  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="newMenuModalLabel">Tambah Jurusan</h5>
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <label for="nama">Nama Jurusan</label>
              <div class="input-group">
                  <input type="text" name="nama" class="form-control" id="nama" placeholder="Nama Jurusan..">
              </div>
            <label for="keterangan">Keterangan</label>
              <div class="input-group">
                  <textarea class="tinymce" name="keterangan" id="keterangan" rows="20"></textarea>
              </div>            
...
<div class="container-fluid">
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-4 text-gray-800">Daftar Jurusan</h1>

    <!-- <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#newMenuModal">Tambah Jurusan</a> -->
    <a href="cetak.php" class="btn btn-primary mb-3" target="_blank">Cetak Semua</a>
    <?php
                if(isset($_GET['pesan'])) {
                  if($_GET['pesan']=="berhasil") {
                    echo "<script>
                              swal('Berhasil', 'Data jurusan berhasil diubah!', 'success');
                          </script>
                    ";
                    ...
                    echo "<script>
                              swal({
                                title: 'Oops!',
                                text: 'Data jurusan gagal diubah!',
                                type: 'warning',
                                });
                          </script>
                    ";
          ...
          <tbody>
            <?php 
              ...
              while($data = mysqli_fetch_array($sql)) {
                ...
                echo "<td width='90'><a href='form_ubah.php?id=".$data['id']."' class='badge badge-success' height='200'><i class = 'fa fa-edit'></i></a>&nbsp;&nbsp;<a href='cetak_jurusan.php?id=".$data['id']."' class='badge badge-success' target='_blank'><i class='fas fa-print'></i></a>&nbsp;&nbsp;<a href='proses_hapus.php?id=".$data['id']."' class='badge badge-danger'><i class = 'fa fa-trash'></i></a></td>";
                echo "</tr>";
                }
              ?>
