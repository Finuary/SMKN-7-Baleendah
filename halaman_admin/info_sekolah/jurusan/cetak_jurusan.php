...
<head>
  ...
  <title>Cetak Halaman Admin</title>
...
<div class="container-fluid">
  ...
  <h1 class="h3 mb-4 text-gray-800" align="center" style="font-size: 40px;">Data Jurusan</h1>
        ...
        <table id="dataTable" class="table table-striped table-bordered data" width="100%" cellspacing="0">
          ...
          <tbody>
            <?php 
              ...
              $id = $_GET['id'];
              $no = 0;
              $sql = mysqli_query($koneksi, "SELECT * FROM jurusan WHERE id = '$id' ORDER BY nama ASC");
