...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div class="container-fluid">
      <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Ubah Tentang Sekolah</h1>
              ...
              <?php
                if(isset($_GET['pesan'])) {
                  if($_GET['pesan']=="berhasil") {
                    echo "<script>
                              swal('Berhasil', 'Tentang Sekolah berhasil diubah!', 'success');
                          </script>
                    ";
                  }else{
                    echo "<script>
                              swal({
                                title: 'Oops!',
                                text: 'Tentang Sekolah gagal diubah!',
                                type: 'warning',
                                });
                          </script>
                    ";
      ...
      <form method="post" action="proses_ubah.php?id=<?php echo $data['id']; ?>" enctype="multipart/form-data">
        ...
        <div>
          <a href="tentang_sekolah.php"><button type="button" class="btn btn-danger">Batal</button></a>
