...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div class="container-fluid">
    	<!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Ubah Profil Sekolah</h1>
              ...
              <?php
                if(isset($_GET['pesan'])) {
                  if($_GET['pesan']=="berhasil") {
                    echo "<script>
                              swal('Berhasil', 'Profil Sekolah berhasil diubah!', 'success');
                          </script>
                    ";
                  }else{
                    echo "<script>
                              swal({
                                title: 'Oops!',
                                text: 'Profil Sekolah gagal diubah!',
                                type: 'warning',
                                });
                          </script>
                    ";
      ...
      <form method="post" action="proses_ubah.php?id=<?php echo $data['id']; ?>" enctype="multipart/form-data">
            <label for="judul">Judul</label>
              ...
              <div class="input-group">
                  <input type="text" name="nama_sekolah" value="<?php echo $data['nama_sekolah']; ?>" class="form-control" id="nama_sekolah">
              </div>
              <label for="npsn_sekolah">NPSN</label>
              <div class="input-group">
                  <input type="text" name="npsn_sekolah" value="<?php echo $data['npsn_sekolah']; ?>" class="form-control" id="npsn_sekolah">
              </div>
              <label for="alamat_sekolah">Alamat</label>
              <div class="input-group">
                  <input type="text" name="alamat_sekolah" value="<?php echo $data['alamat_sekolah']; ?>" class="form-control" id="alamat_sekolah">
              </div>
              <label for="telp_sekolah">Telepon</label>
              <div class="input-group">
                  <input type="text" name="telp_sekolah" value="<?php echo $data['telp_sekolah']; ?>" class="form-control" id="telp_sekolah">
              </div>
              <label for="email_sekolah">Email</label>
              <div class="input-group">
                  <input type="text" name="email_sekolah" value="<?php echo $data['email_sekolah']; ?>" class="form-control" id="email_sekolah">
              </div>
              <label for="jurusan_sekolah">Jurusan</label>
              <div class="input">
                <textarea class="tinymce" name="jurusan_sekolah" id="jurusan_sekolah" rows="20"><?php echo $data['jurusan_sekolah']; ?></textarea>
              </div>
              <br>            
      </div>
        </div>
