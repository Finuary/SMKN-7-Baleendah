  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link collapsed" href="" data-toggle="collapses" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
...
<div class="container-fluid">
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-4 text-gray-800">Tambah dan Daftar Siswa</h1>

    <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#newMenuModal">Tambah Siswa</a>
    ...
    <?php
      ...
      <div class="table-responsive">
        <table id="dataTable" class="table table-striped table-bordered data" width="100%">
          <thead>
            <tr>
              <th>NO</th>
              <th>NIS</th>
          ...
          <tbody>
            <?php 
              ...
              while($data = mysqli_fetch_array($sql)) {
                ...
                echo "<tr>";
                echo "<td>$id</td>";
                echo "<td width='10'>".$data['nis']."</td>";
                echo "<td width='200'>".$data['nama']."</td>";
                echo "<td width='150'>".$data['jenis_kelamin']."</td>";
                echo "<td>".$data['alamat']."</td>";
                echo "<td width='220'>".$data['jurusan']."</td>";
                echo "<td><img src='../images/".$data['foto']."' width='100' height='100'></td>";
                echo "<td width='90'><a href='form_ubah.php?id=".$data['id']."' class='badge badge-success'><i class='fa fa-edit'></i></a>&nbsp;&nbsp;<a href='cetak_siswa.php?id=".$data['id']."' class='badge badge-success' target='_blank'><i class='fas fa-print'></i></a>&nbsp;&nbsp;<a href='proses_hapus.php?id=".$data['id']."' class='badge badge-danger'><i class='fa fa-trash'></i></a></td>";
                echo "</tr>";
              } 
            ?>
          </tbody>
