  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link collapsed" href="tambah_siswa.php" data-toggle="collapses" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
    ...
    <div class="container-fluid">
      ...
      <form method="post" action="proses_ubah.php?id=<?php echo $id; ?>" enctype="multipart/form-data">
      	<label for="nis">NIS</label>
              <div class="input-group">
                  <input type="text" name="nis" value="<?php echo $data['nis']; ?>" class="form-control" id="nis" placeholder="NIS..">
              </div>
        ...
        <div>
        	<a href="tambah_siswa.php"><button type="button" class="btn btn-danger">Batal</button></a>
