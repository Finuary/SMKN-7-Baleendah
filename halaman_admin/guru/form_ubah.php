  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link collapsed" href="tambah_guru.php" data-toggle="collapses" data-target="#collapsePages" aria-expanded="true" aria-controls="collapsePages">
          <i class="fa fa-users"></i>
          <span>Data Guru</span>
        </a>
      </li>
    ...
    <div class="container-fluid">
      ...
      <form method="post" action="proses_ubah.php?id=<?php echo $id; ?>" enctype="multipart/form-data">
        <label for="nip">NIP</label>
              <div class="input-group">
                  <input type="text" name="nip" value="<?php echo $data['nip']; ?>" class="form-control" id="nip" placeholder="NIP..">
              </div>
            <label for="nama">Nama</label>
              <div class="input-group">
                  <input type="text" name="nama" value="<?php echo $data['nama']; ?>" class="form-control" id="nama" placeholder="Nama..">
              </div>
              <label for="mata_pelajaran">Mata Pelajaran</label>
              <div class="input-group">
                  <input type="text" name="mata_pelajaran" value="<?php echo $data['mata_pelajaran']; ?>" class="form-control" id="mata_pelajaran" placeholder="Mata Pelajaran..">
              </div>
        ...
        <div>
          <a href="tambah_guru.php"><button type="button" class="btn btn-danger">Batal</button></a>
