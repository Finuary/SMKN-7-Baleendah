  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link collapsed" href="tambah_user.php" data-toggle="collapses" data-target="#collapsePagess" aria-expanded="true" aria-controls="collapsePagess">
          <i class="fa fa-users"></i>
          <span>User</span></a>
      </li>
      ...
      <form method="post" action="proses_ubah.php?id=<?php echo $id; ?>" enctype="multipart/form-data">
      	<label for="nama">Nama</label>
            ...
            <label for="email">Email</label>
              ...
              <div class="input-group">
                  <input type="text" name="password" value="<?php echo $data['password']; ?>" class="form-control" id="password" placeholder="Password..">
              </div>
        ...
        <div>
        	<a href="tambah_user.php"><button type="button" class="btn btn-danger">Batal</button></a>
