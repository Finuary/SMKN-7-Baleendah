...
<div class="container-fluid">
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-4 text-gray-800">Tambah dan Daftar User</h1>
        ...
        <table id="dataTable" class="table table-striped table-bordered data" width="100%" cellspacing="0">
          ...
          <tbody>
            <?php 
              include "../../koneksi.php";
              $no = 0;
              $sql = mysqli_query($koneksi, "SELECT * FROM user ORDER BY level ASC");
              ...
              while($data = mysqli_fetch_array($sql)) {
                ...
                echo "<td align='center'><a href='form_ubah.php?id=".$data['id']."' class='badge badge-success'><i class='fa fa-edit'></i></a>&nbsp;&nbsp;<a href='cetak_user.php?id=".$data['id']."' class='badge badge-success' target='_blank'><i class='fas fa-print'></i></a>&nbsp;&nbsp;<a href='proses_hapus.php?id=".$data['id']."' class='badge badge-danger'><i class='fa fa-trash'></i></a></td>";
                echo "</tr>";
              } 
            ?>
          </tbody>
