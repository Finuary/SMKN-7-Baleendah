  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link collapsed" href="" data-toggle="collapses" data-target="#collapsePagess" aria-expanded="true" aria-controls="collapsePagess">
          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block text-center">
                <?php echo "<img src='../../halaman_admin/images/".$data['foto']."' width='350' height='350'>"; ?>
              </div>
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <div class="text-center text-gray-900">
                    ...
                    <hr>
                    <div class="h5 text-center text-gray-900">
                      <a href=""><i class="fab fa-facebook-f"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <a href=""><i class="fab fa-whatsapp"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <a href=""><i class="fab fa-instagram"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </div>
                    <hr>
                    <?php echo "<a href='form_ubah.php?id=".$data['id']."' class='btn btn-primary btn-block'>Ubah</a>"; ?>
                </div>
              </div>
            </div>
          </div>
