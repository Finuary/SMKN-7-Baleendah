...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="guru/guru.php" data-toggle="collapses" data-target="#collapsePages" aria-expanded="true" aria-controls="collapsePages">
          <i class="fa fa-users"></i>
          <span>Data Guru</span>
        </a>
      </li>
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="profil/profil.php" data-toggle="collapses" data-target="#collapsePagess" aria-expanded="true" aria-controls="collapsePagess">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <?php echo "<img class='img-profile rounded-circle' src='../halaman_admin/images/".$data['foto']."' width='350' height='350'>"; ?>
              </a>
          ...
          <tbody>
            <?php 
              ...
              while($data = mysqli_fetch_array($sql)) {
                ...
                echo "<td width='210'>".$data['jurusan']."</td>";
                echo "<td><img src='../halaman_admin/images/".$data['foto']."' width='100' height='100'></td>";
                echo "</tr>";
              } 
            ?>
          </tbody>
